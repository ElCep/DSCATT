...
object Diohine {
  ...
  def main(args: Array[String]) =
    ...
    //println("GINI:" + col)
    //println("Effective Gini for " + col + ": " + utils.gini(col.map(_.toDouble)))
    //println("score " + KitchenProfiler.solidarityScore(LoanStrategy.Selfish, FoodDonationStrategy.FoodForAllStrategy))
  ...
  def unitary(seed: Long, lands: java.io.File, pg: Double = 0.014, kitchenPartition: KitchenPartition = defaultKitchenProfiler.kitchenPartition) = {
