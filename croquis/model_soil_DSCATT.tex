...
On n'avait pas identifié que l'azote restant apparaissait \textbf{deux fois} dans le modèle : une fois dans $N_{remaining}$, et une autre fois dans le terme $QS$. Est-ce qu'il faut le prendre deux fois en compte ? (je ne pense pas)
\end{tcolorbox}
