...
\begin{figure}
     ...
     \end{subfigure}
        \caption{Données de l'observatoire de Niakar entre 1985 et 2020. la fig \subref{fig:pop} représente l'évolution de la population, la fig. \subref{fig:cuisines} montre l'évolution du nombre de cuisine sur la même période. Enfin on trouvera dans la fig. \subref{fig:tailleCuisines} le nombre de personne moyen par cuisine sur la même période.}
